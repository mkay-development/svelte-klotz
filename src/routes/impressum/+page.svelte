<div class="grid grid-cols-6 gap-2">
    <div class="col-span-6">
      ...
      <p>
        Jonathan Martz <br /> Othestrasse 2<br /> 51702 Bergneustadt <br /><br />
      </p>
      <h2><strong>Vertreten durch: </strong></h2>
      <p>Jonathan Martz<br /><br /></p>
      <h2><strong>Kontakt:</strong></h2>
      <p>
        E-Mail: <a href="mailto:impresum@jmartz.de"> impressum@jmartz.de </a><br
        /><br />
      </p>
      <h2><strong>Haftungsausschluss: </strong></h2>
      <p>
        <br /><br /><strong>Haftung für Inhalte</strong><br /><br /> Die Inhalte
        ...
        entfernen. <br /><br /><strong>Datenschutz</strong><br /><br /> Die
      ...
      <p>
        ...
        übermittelt. Dies sind:<br /><br /> · Browsertyp und Browserversion<br />
        · verwendetes Betriebssystem<br /> · Referrer URL<br /> · Hostname des
        zugreifenden Rechners<br /> · Uhrzeit der Serveranfrage<br /> · IP-Adresse<br
        /><br /><br /> Eine Zusammenführung dieser Daten mit anderen Datenquellen
        wird nicht vorgenommen.<br /> Grundlage für die Datenverarbeitung ist Art.
        6 Abs. 1 lit. f DSGVO, der die Verarbeitung von Daten zur Erfüllung eines Vertrags
